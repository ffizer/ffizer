...
impl SampleCfg {
    ...
    fn make_ignores(&self) -> Result<Vec<PathPattern>> {
        ...
        let ignores = self
            ...
            .chain([PathPattern::from_str(cfg::FFIZER_DATASTORE_DIRNAME)]) // Ignore ffizer internal that may change from one ffizer version to another
